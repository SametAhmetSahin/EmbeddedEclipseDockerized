...
sudo docker run --rm -it -v /tmp/.X11-unix:/tmp/.X11-unix -e DISPLAY=$DISPLAY --device /dev/bus/usb/002 -v "/home/$USER/EmbeddedEclipse/projects/:/apps/projects/:rw" --hostname "eclipsedockerized" embeddedeclipsedockerizeduservariant xterm #/app/eclipse/eclipse
